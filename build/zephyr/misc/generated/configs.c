...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_SIZE, 1500);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_NET_ICMPV4_ACCEPT_BROADCAST, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_KEEPALIVE, 600);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MQTT_LIB_WEBSOCKET, 1);
